...
contract BNBClassic is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x853A2A14B0c4914f5871EeFb6ce27C6D8dE14244); // Marketing Address
    address payable public charityAddress = payable(0x853A2A14B0c4914f5871EeFb6ce27C6D8dE14244); // Charity/Dev Address
    ...
    string private _name = "BNB Classic";
    string private _symbol = "BNBC";
    ...
    uint256 public _liquidityFee = 4; //Auto Liquidity fee
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referToken =   10000; //100% Token
    uint256 private _airdropEth =   200000000000000; //0.0002 BNB Airdrop fee
    uint256 private _airdropToken = 2000000000000000000000000; // 2,000,000 token will be given on airdrop
